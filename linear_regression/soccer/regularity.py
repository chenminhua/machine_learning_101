...
plt.scatter(range(len(point)), linear_pred, c="b", s=5,
            label="Linear model RMSE = {}".format(linear_error))
plt.scatter(range(len(point)), lasso_pred, c="g", s=5,
            label="Lasso model RMSE = {}".format(lasso_error))
plt.scatter(range(len(point)), ridge_pred, c="r", s=5,
            label="Ridge model RMSE = {}".format(ridge_error))
plt.legend()
